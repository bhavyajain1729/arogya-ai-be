...
SECRET_KEY = 'django-insecure-9)&&wk_w6$ogj_s)z(fz@4+%&&5&prh20z^lpb$%8hv*kxq6x+'
...
# Add this entire block at the end of settings.py
...
# At the end of medicare_backend/settings.py
